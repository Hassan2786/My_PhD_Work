...
n_val2 = int(n_val1*0.05) # 80% of the test dataset
...
D_src = torch.ones(8, 1).to(device) # Discriminator Label to real
D_tgt = torch.zeros(7, 1).to(device) # Discriminator Label to fake
