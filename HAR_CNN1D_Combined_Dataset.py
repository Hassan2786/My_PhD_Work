...
class ConvNet(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(3648, 120)  #self.fc1 = nn.Linear(1760, 120)  for Mag and Phase separately and 3648 for combined both
...
with torch.no_grad():
    ...
    for i in range(7):
        #print(f'No of samples {n_class_samples[i]}')
