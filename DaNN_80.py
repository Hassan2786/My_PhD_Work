...
train_dataset_path="./Dataset_S1_S2_S3/training2/training"
test_dataset_path="./Dataset_S1_S2_S3/training1/training"
...
n_val2 = int(n_val1*0.8) # 80% of the test dataset
...
if __name__ == "__main__":
    ...
    plt.ylabel('Loss')
    plt.xlabel('Epoch')
    plt.legend(['Model Training Loss (MMD)'], loc='upper right')
    ...
    plt.ylabel('Accuracy')
    plt.xlabel('Epoch')
    plt.legend(['Model Training Accuracy (MMD)'],loc='lower right')
    plt.xlim([1, epoch_num_Encoder])
